...
\begin{enumerate}
  ...
  \item El tiempo propio de este módulo. Demora entre el instante en cual el flanco ascendente de la pausa es detectado y la activación de la salida \textit{trigger} que dispara la transmisión de la respuesta.
